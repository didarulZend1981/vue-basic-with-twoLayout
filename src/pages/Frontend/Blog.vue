<template>
		...
		<div class="container box margin-bottom">
			<!--===============================-->
				<!--== Blog =============-->
				<!--===============================-->
                <section id="blog" class="row">
						<div class="title-start col-md-4 col-md-offset-4 margin-top"><h2>Blog</h2>	
						<p class="sub-text text-center ">Awesome news and articles from us</p>	
							...
							<div class="blog col-md-4">
								...
								<img class="blog-image" src="../../assets/forntend-layout/images/demo/blog2.jpg" width="100%" height="250" alt="Blog Image 2"/>
							...
							<div class="blog col-md-4">
								...
								<img class="blog-image" src="../../assets/forntend-layout/images/demo/blog1.jpg"  width="100%" height="250" alt="Blog Image 2"/>
